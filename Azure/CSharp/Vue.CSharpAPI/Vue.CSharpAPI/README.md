...
```sh
docker build -t Vue.CSharpAPI .
docker run -p 8080:80 Vue.CSharpAPI
# open http://localhost:8080
```

## Questions? Issues?

The [GitHub repo for this template is here](https://github.com/robconery/Vue.CSharpAPI). I don't have discussions enabled, but feel free to pop an issue if you like or, better yet, a PR!
